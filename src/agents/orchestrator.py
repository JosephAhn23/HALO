...
class Pipeline:
    ...
    def _behavioral_gate(self, state: AgentState) -> AgentState:
        ...
        from src.safety.behavioral_classifier import classify_user_prompt
    ...
    def _cost_route_gate(self, state: AgentState) -> AgentState:
        ...
        if self.cost_router is None or state.get("error") or state.get("skip_rag"):
            return state
        from src.agents.multi_agent.cost_router import ABSTAIN_ANSWER
    ...
    def _policy_enforcement(self, state: AgentState) -> AgentState:
        ...
        if not ans:
            return state
        from src.agents.multi_agent.policy_enforcement_agent import enforce_grounded_answer
    ...
    def _consensus_quality_gate(self, state: AgentState) -> AgentState:
        ...
        from src.agents.multi_agent.cross_provider_consensus import TruthCommitteeOutcome
    ...
    def _attribution_step(self, state: AgentState) -> AgentState:
        ...
        from src.context_engineering.mandatory_attribution import compute_grounding_confidence
