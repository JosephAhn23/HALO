...
class ResearchAgent(BaseAgent):
    ...
    def __init__(
        self,
        name: str = "researcher",
        retrieval_fn: Callable[[str], list[dict]] | None = None,
    ...
    def _default_retrieve(self, query: str) -> list[dict]:
        ...
        return [
            {
                "doc_id": "doc_001",
                "text": "RAG uses retrieval to ground LLM responses in external knowledge, enabling up-to-date answers without retraining.",
                "score": 0.91,
            },
            {
                "doc_id": "doc_002",
                "text": "Fine-tuning embeds domain knowledge into model weights. More expensive but provides deeper stylistic consistency.",
                "score": 0.84,
            },
            {
                "doc_id": "doc_003",
                "text": "Hybrid approaches combine RAG for factual grounding with fine-tuning for domain tone and format.",
                "score": 0.79,
            },
        ]
